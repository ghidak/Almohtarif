...
async def how_to_get_points(message: Message):
    await message.answer(
        "💡 كيف تحصل على نقاط؟\n\n"
        "1️⃣ عند تسجيل كل مستخدم جديد عن طريق رابط الإحالة الخاص بك، تحصل على نقطة مجانية.\n"
        "2️⃣ يمكن أن يتم توزيع نقاط مجانية من قِبل الإدارة أحياناً.\n\n"
        "📢 شارك رابط الإحالة الخاص بك مع أصدقائك لزيادة رصيدك من النقاط واستخدمها للحصول على بروكسيات أمريكية!"
    )
)
